...
import { Loader2, Flame, AlertCircle, ArrowRight, Check, Sparkles, CalendarDays, Wallpaper } from "lucide-react";
import { signInEmail, signUpEmail, signInGoogle, resetPassword, friendlyError } from "../../lib/auth";
...
export function LiquidLoadingOverlay({ label }: { label: string }) {
  return (
    <div
...
export function OnboardingScreen({ defaultName, onDone }: { defaultName: string; onDone: (name: string, selectedPackId?: string) => void }) {
