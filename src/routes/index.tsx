...
function SheetShell({
  ...
  return (
    <div
      onClick={onClose}
      className="absolute inset-0 z-40 flex items-end justify-center bg-black/60 backdrop-blur-sm animate-fade-in"
    >
      <div
        onClick={(e) => e.stopPropagation()}
        className="w-full max-h-[85vh] overflow-y-auto rounded-t-[24px] bg-canvas p-5"
      >
        <div className="mx-auto mb-4 h-1 w-12 rounded-full bg-[color:var(--surface-pressed)]" />
        <div className="mb-5 flex items-center justify-between">
          ...
          <button
            onClick={onClose}
            className="grid h-8 w-8 place-items-center rounded-full bg-canvas-soft text-ink"
            aria-label="Close"
          >
            <X className="h-4 w-4" />
          </button>
